            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Data Sampah</h2>
...
$sql=mysqli_query($con,"SELECT * FROM sampah");
if(isset($_POST['qcari'])){
  $qcari = $_POST['qcari'];
$sql=mysqli_query($con,"SELECT * FROM sampah where id_sampah like 
  '%$qcari%' or nama_jenis like '%$qcari%' ");
}
$nomor = 0;
