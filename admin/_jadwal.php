                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form method="post" action="_tambah_jadwal.php" >
   ...
   ?> 
     ...
     <?php }?>                                               </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-pament" name="kelas" type="text" placeholder="1 - 3 - 5" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-pament" name="jam" type="text" placeholder="06:00-12:00" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-number" name="harga" type="tel" class="form-control cc-number identified visa"  data-val="true"
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" name="jadwal" class="btn btn-lg btn-info btn-block">
