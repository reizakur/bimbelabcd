<?php include ('awalan.php');?>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Tambah Sekolah</h3>
                                        </div>
                                        <hr>
                                        <form method="post"  action="_tambah_kelas.php" >
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Nama Jenis</label>
                                                <input id="cc-pament" name="kelas" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            <div>
                                                <button id="payment-button" type="submit" name="kirim" class="btn btn-lg btn-info btn-block">
                                                    <i class="fa fa-send fa-lg"></i>&nbsp;
                                                    <span id="payment-button-amount" name="kirim">Kirim</span>
              ...
              <p> </p>   <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Data Sekolah</h2>
